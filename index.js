...
// 3.
var filterSpecies = dogs.filter(e => e.species === 'dog');
...
// 5. 
var dogsWithClasses = dogContestants.map(e => {
    if (e.weight < 11) e.class = 'red';
    if (e.weight < 21 && e.weight > 10) e.class = 'yellow';
    if (e.weight > 20) e.class = 'green';
    return e;
});
